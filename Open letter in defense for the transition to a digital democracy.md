...
B.  Data from the International Institute for Democracy and Electoral Assistance (International IDEA) reveal worrying numbers regarding participation in electoral processes. If abstention is an indicator of voters' apathy and lack of confidence in the political system, what conclusion should be drawn from the low civic participation in political activity (…) with a decrease in the average global value of participation of 78% in the 40's to 66% during the 2010s and on a declining trend.
