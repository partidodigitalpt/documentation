SPECIFIC STATUTES FOR A POLITICAL PARTY THAT IS

SUPPORTED BY A DECENTRALIZED APPLICATION

The Crypto Anarchist Manifesto by Timothy May in 1988
...
Party statutes stipulate how political parties organise their inner structure; how they form assemblies, how members are elected to the party organs or how they represent each other in face of other institutions. How lists are made for electoral processes and other more mundane tasks that are required for the party to function as expected such as how the revenues are made, etc., are all stipulated in this type of documents.

The reason for this small print to exist originated from the verification by the author that most of the political party statutes to date have not been considerably changed since their conception, decades ago. This poses a problem specially considering that remote e-voting has become better understood and is expected soon to be an important part in everyday politics.

What fundamental changes are to be expected when remote e-voting becomes widely adopted in reality? If quick and reliable on-line referendums are possible, what would this entail in the organisation of “traditional” party politics? If video conferencing allows people to debate and publish in a media which today is faster, more accessible, with broadband and wireless networks widely available, what kind of changes could we envision that would make us benefit from using these technologies?

The current document is based on the idea that the most important changes are essentially fourfold:

1.   The addition of an on-line platform for political discussion where users can exchange messages securely, in privacy and vote on-line, through the internet.

1.  The addition of internal structures that reinforce protection against bad actors through Coordinations of Defense for Integrity and Ethics.

1.   In the same spirit of the previous point the formation of scientific working groups … economic, lega...

2.  Integration of cryptocurrencies as a means for more transparent exchange…..dadasdasd
...
Ordering according to the alphabet and

ISO 3166-1 alpha-2

Administrative regions divisions

Local - asadad

Regional level (mid level) – Borough, Daira, …

Inter-regional ? - asdasda

National – asdsad?

Elections

Local electoral elections – asdasd

National (legislative) elections – asdasds

Parliament

https://en.wikipedia.org/wiki/Nomenclature\_of\_Territorial\_Units\_for\_Statistics

https://en.wikipedia.org/wiki/Local\_government
